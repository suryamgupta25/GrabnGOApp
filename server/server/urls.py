...
from endpoints import firebase_views

urlpatterns = [
    path("admin/", admin.site.urls),
    # path('', views.index, name='index'), 
    path('', firebase_views.tryAddingData, name='tryAddingData'), 
    path('login', firebase_views.tryLogin, name='tryLogin'),  
    path('addcustomer', firebase_views.tryAddCustomer, name='tryAddCustomer'),
